...
internal class IconStore
{
    ...
    private readonly Dictionary<IconId, string> PathByIconId = new()
    {
        ...
        { IconId.House1, "assets/housing-markers/1.png" },
        { IconId.House2, "assets/housing-markers/2.png" },
        { IconId.House3, "assets/housing-markers/3.png" },
        { IconId.House4, "assets/housing-markers/4.png" },
        { IconId.House5, "assets/housing-markers/5.png" },
        { IconId.Hotel, "assets/housing-markers/5.png" },
