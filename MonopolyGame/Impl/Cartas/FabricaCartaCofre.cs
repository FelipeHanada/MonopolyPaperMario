    ...
    public CartaCofre CriaCarta(CartasCofre cartaId)
    {
        CartaCofre carta = cartaId switch
        {
            CartasCofre.CartaAntiGuys => new CartaCofre(
                ...
                new EfeitoDebitoFixo(partida, VALOR_DEBITO_ANTIGUYS)
            ),
            CartasCofre.CartaBandits => new CartaCofre($"Bandits roubaram parte das suas moedas. Pague $60.", new EfeitoDebitoFixo(partida, 60)),
            ...
            CartasCofre.CartaKetchnkoopa => new CartaCofre(
                ...
                new EfeitoDebitoFixo(partida, VALOR_DEBITO_KETCHNKOOPA)
            ),
            CartasCofre.CartaKoopaKoot => new CartaCofre(
                ...
                new EfeitoCreditoFixo(partida, VALOR_CREDITO_KOOPAKOOT)
            ),
            CartasCofre.CartaMerlee => new CartaCofre(
                ...
                new EfeitoCreditoFixo(partida, VALOR_CREDITO_MERLEE)
            ),
            CartasCofre.CartaMerluvelee => new CartaCofre(
                ...
                new EfeitoCreditoFixo(partida, VALOR_CREDITO_MERLUVELEE)
            ),
            CartasCofre.CartaMistake => new CartaCofre(
                ...
                new EfeitoDebitoFixo(partida, VALOR_DEBITO_MISTAKE)
            ),
            ...
            CartasCofre.CartaShopping => new CartaCofre(
                ...
                new EfeitoDebitoFixo(partida, VALOR_DEBITO_SHOPPING)
            ),
            CartasCofre.CartaWhacka => new CartaCofre(
                ...
                new EfeitoCreditoFixo(partida, VALOR_CREDITO_WHACKA)
            ),
            CartasCofre.CartaYoshiKids => new CartaCofre(
                ...
                new EfeitoCreditoFixo(partida, VALOR_CREDITO_YOSHIKIDS)
            ),
