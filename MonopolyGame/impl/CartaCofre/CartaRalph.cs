...
{
    internal class CartaRalph : MonopolyPaperMario.MonopolyGame.Model.CartaCofre 
    {
        private const int VALOR_DEBITO = 150;

        public CartaRalph() : base(
            // Descrição da Carta
            $"Você foi na loja de badges do ralph's shop e gastou demais. Pague ${VALOR_DEBITO}.", 
